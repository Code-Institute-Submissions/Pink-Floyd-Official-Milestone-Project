...
##### Functional Test 1 (FT-1)
###### Test
Navigation bar responsive design
###### Scope 
All HTML pages
###### Success Criteria 
Full navigation bar visibility on screens with resolutions of 992px and higher; navigation icon displayed on screens with resolutions of 991px and smaller.
###### Results
Passed with no issues

##### Functional Test 2 (FT-2)
###### Test
Collapsing and expanding navigation bar upon click on screens with resolution < 992px
###### Scope 
All HTML pages
###### Success Criteria 
Navigation icons displayed and hidden upon successive clicks
###### Results
Passed with no issues

##### Functional Test 3 (FT-3)
###### Test
Navigation icons link 
###### Scope 
All HTML pages, independent of screen resolution
###### Success Criteria 
Navigation icons link to correct website page upon click
###### Results
Passed with no issues

##### Functional Test 4 (FT-4)
###### Test
Navigation icons and text grow upon hover
###### Scope 
All HTML pages on screens with resolutions of 992px and higher
###### Success Criteria 
Navigation icons and text grow upon hover
###### Results
Passed with no issues
...
##### Functional Test 4 (FT-4)
###### Test
Footer alert text link
###### Scope 
All HTML pages
###### Success Criteria 
Footer alert links to correct website page upon click
###### Results
Passed with no issues

##### Functional Test 5 (FT-5)
###### Test
Social media icon links
###### Scope 
All HTML pages with resolutions of 992px and higher
###### Success Criteria 
Social media icons link to correct website page upon click
###### Results
Passed with no issues

##### Functional Test 6 (FT-6)
###### Test
...
##### Functional Test 3 (FT-3)
###### Test
Social media icons hidden on screen resolutions less than 992px
###### Scope 
All HTML pages
###### Success Criteria 
Social media icons hidden below 992px and visible on reoslutions of 992px and above
###### Results
Passed with no issues
